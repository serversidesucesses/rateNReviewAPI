    ...
    <svg
      ...
      <defs>
        <linearGradient id={`partial_${index}`}>
          <stop offset={`${percent}%`} stopColor="orange" />
      ...
      <path
        ...
        l42.163-149.692L54.058,221.779l155.404-6.163l53.875-145.885l53.885,145.885l155.394,6.163l-122.096,96.337L392.683,467.808z" stroke="orange" strokeWidth="30" data-star-id={starId} />
    </svg>
  );
}
